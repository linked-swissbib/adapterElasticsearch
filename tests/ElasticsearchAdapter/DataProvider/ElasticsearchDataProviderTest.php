...
class ElasticsearchDataProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $paramaters =  Yaml::parse(file_get_contents('tests/Resources/elasticsearch_adapter.yml'));
        //$paramaters =  Yaml::parse(file_get_contents('../../../tests/Resources/elasticsearch_adapter.yml'));
    ...
    public function testAdapter()
    {
        ...
        $this->assertTrue($result["hits"]["total"] == 872,"expected number of hits == 872 isn't true");
